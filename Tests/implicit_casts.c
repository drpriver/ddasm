...
int main(){
    ...
    short s4 = 300;
    int i19 = s3 * s4;
    if(i19 != 90000) die();  // 90000 > 32767 (short max)
    ...
    char c4 = 15;
    int i21 = c3 * c4;
    if(i21 != 300) die();  // 300 > 127 (signed char max)

    // unsigned char + unsigned char -> int
    unsigned char uc1 = 200;
    unsigned char uc2 = 100;
    int i22 = uc1 + uc2;
    if(i22 != 300) die();  // 300 > 255 (unsigned char max)
    ...
    if(u2 != 9) die();  // wraps: 0xFFFFFFFF + 10 = 9
