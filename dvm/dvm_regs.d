...
enum RegisterNames:uintptr_t {
    R0  = 0,  R1  =  1, R2  = 2,  R3  = 3,  R4  = 4,  R5  = 5,  R6  = 6, R7 = 7, // args
    R8  = 8,  R9  = 9,  R10 = 10, R11 = 11, R12 = 12, R13 = 13, R14 = 14, // scratch
...
immutable RegisterInfo[40] registerinfos = [
    ...
    RegisterInfo(RegisterNames.R8,      "RS0",      "rs0"),
    RegisterInfo(RegisterNames.R9,      "RS1",      "rs1"),
    RegisterInfo(RegisterNames.R10,     "RS2",      "rs2"),
    RegisterInfo(RegisterNames.R11,     "RS3",      "rs3"),
    RegisterInfo(RegisterNames.R12,     "RS4",      "rs4"),
    RegisterInfo(RegisterNames.R13,     "RS5",      "rs5"),
    RegisterInfo(RegisterNames.R14,     "RS6",      "rs6"),
